...
class Sheet(CommonAbstractModel):
    ...
    date_debut = models.DateField(auto_now=False, auto_now_add=False,null=True, verbose_name="Date de début du cours")
    date_fin = models.DateField(auto_now=False, auto_now_add=False,null=True, verbose_name="Date de fin du cours")
