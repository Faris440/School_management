    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'ADMINISTRATEUR'), ('student', 'Etudiant'), ('teacher', 'Enseignat')], default='student', max_length=20, verbose_name="Type d'utilisateur")),
                ...
                ('is_student', models.BooleanField(default=False, verbose_name='Est un(e) étudiant(e)')),
                ...
                ('marital_status', models.CharField(choices=[('bachelor', 'Célibataire'), ('married', 'Mariée'), ('divorced', 'Divorcée'), ('widower', 'Veuve')], default='bachelor', max_length=20, verbose_name='Situation matrimonial')),
            ...
            options={
                ...
                'permissions': [('list_user', 'Can list user'), ('can_assign', 'Peut attribuer un rôle'), ('deactivate_user', 'Can deactivate user'), ('change_right_user', 'Can change user right'), ('access_parameter', 'Can access to parameter module'), ('access_account', 'Can access to account module')],
            },
            managers=[
