    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_nomination', models.DateField(max_length=100, null=True, verbose_name='Date de nomination')),
                ...
                ('departement', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_department', to='parameter.departement')),
                ('filiere', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_filiere', to='parameter.filiere')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('ufr', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_urf', to='parameter.unitederecherche')),
